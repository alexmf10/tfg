...
| ALTA | S-06 · orden de clases | CODA-Prompt · ambos | El paper declara que distintos shuffles cambian la dificultad y los resultados; repo actual con repeat 1/seed 0 y Mammoth canónico usan orden nativo. | Paper `sections/5_experiments.tex:14`, `sections/7_appendix.tex:25`; repo `experiments/cifar-100.sh:9-14`, `trainer.py:58-76`; Mammoth `utils/args.py:274-281,359-362`, `datasets/utils/continual_dataset.py:212-232`. |
